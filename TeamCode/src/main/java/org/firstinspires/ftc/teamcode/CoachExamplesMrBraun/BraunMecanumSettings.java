...
public class BraunMecanumSettings {
    ...
    // Fields for Vuforia and TFOD - Class members
    ...
    public void initVision (LinearOpMode opMode) throws InterruptedException {
        ...
        // (typically 1.78 or 16/9). Uncomment the following line if you want to adjust the magnification and/or the aspect ratio of the input images.
        **/
    ...
    public boolean targetsAreVisible() throws InterruptedException {
    ...
    public boolean targetIsVisible(int targetId) throws InterruptedException {
    ...
    void initTfod(LinearOpMode opMode) throws InterruptedException {
        botOpMode = opMode;
    ...
    public void deactivateTfod() throws InterruptedException {
        tfod.deactivate();
    }
